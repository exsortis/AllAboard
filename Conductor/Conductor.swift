...
public class Conductor {
     ...
     */
    public class func viewControllerWithDataSource(_ dataSource : ConductorDataSource, delegate : ConductorDelegate? = nil) -> ConductorViewController? {
     ...
     */
    public static var titleFont : UIFont = UIFont.boldSystemFont(ofSize: 24)
    /**
     ...
     */
    public static var advanceButtonFont : UIFont = UIFont.systemFont(ofSize: 17)
    /**
     * Sets the font used for the skip button in all page views. Defaults to the system font at point size 11.
     */
    public static var skipButtonFont : UIFont = UIFont.systemFont(ofSize: 11)
